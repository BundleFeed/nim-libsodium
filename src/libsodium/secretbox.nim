...
func secretBoxEncrypt*(source: Message, nonce: SecretBoxNonce, key: SecretBoxKey, target: var Message) =
    ...
    checkRc crypto_secretbox_easy(addr target[0], addr source[0], source.msgLen.culonglong, nonce.address, key.address)

func secretBoxEncrypt*(source: Message, nonce: SecretBoxNonce, key: SecretBoxKey) : seq[byte] =
    result.setLen(source.secretBoxLen)
    checkRc crypto_secretbox_easy(addr result[0], addr source[0], source.msgLen.culonglong, nonce.address, key.address)
...
func secretBoxDecrypt*(source: Message, nonce: SecretBoxNonce, key: SecretBoxKey, target: var Message) =
    ...
    checkRc crypto_secretbox_open_easy(addr target[0], addr source[0], source.msgLen.culonglong, nonce.address, key.address)
...
func secretBoxDecrypt*(source: Message, nonce: SecretBoxNonce, key: SecretBoxKey) : seq[byte] =
    ...
    checkRc crypto_secretbox_open_easy(addr result[0], addr source[0], source.msgLen.culonglong, nonce.address, key.address)